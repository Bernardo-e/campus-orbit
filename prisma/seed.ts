...
// Seed users for preloaded Q&A and general data
const seedUsers = [
  { name: "Bernardo",      email: "berncarl1723@gmail.com", password: "password123", targetExam: "JEE Main",     targetBranch: "Computer Science" },
  { name: "Berd",          email: "berdnard2007@gmail.com", password: "password123", targetExam: "JEE Advanced", targetBranch: "Computer Science" },
  { name: "Ananya Patel",  email: "ananya.patel@gmail.com", password: "password123", targetExam: "TNEA",         targetBranch: "Information Technology" },
];
...
const qnaData = [
  {
    ...
    answers: [
      ...
      { author: "Bernardo",   body: "Agree with the above. Also check the previous 5 years' opening and closing ranks on JOSAA's official portal. The cutoffs shift slightly each year based on total candidates. Mock allotment in round 1 is a good indicator. Lock NIT Trichy CSE as your top choice if it's your dream branch." },
      { author: "Ananya Patel",   body: "One tip: don't forget that choice-locking strategy matters a lot. Fill as many choices as possible in preference order. Many students with rank 1200 panic and fill fewer than 20 choices. Fill 40+ choices to maximize your chances across multiple NITs and IIITs." },
    ],
  },
  {
    author: "Ananya Patel",
    ...
    answers: [
      { author: "Bernardo",  body: "What's the average package for CSE students? And how competitive is it to get into research projects in your first or second year?" },
      ...
      { author: "Berd",  body: "Is the deer actually still on campus? I heard IIT Madras has a protected forest inside. Planning to visit during open day!" },
  ...
  },
  {
    ...
    answers: [
      { author: "Ananya Patel",   body: "CEG CSE is the gold standard in Anna University — historically the best placements, top companies visit exclusively for CEG. With 196.5 you might just make it to CEG CSE (cutoff usually around 196–198). Prioritize CEG CSE >> MIT IT >> CEG IT in that order." },
      { author: "Bernardo", body: "MIT campus is excellent for core electronics and aeronautical branches, but for software IT roles, CEG has a stronger alumni network. If your cutoff gets you CEG CSE, take it without second thoughts." },
      { author: "Bernardo",  body: "Also consider that CEG is the main campus — all central facilities are there. MIT is about 30 mins away which can be inconvenient for events and inter-campus activities." },
    ],
  },
  {
    author: "Bernardo",
    ...
    answers: [
      { author: "Ananya Patel",   body: "How many students from CSE actually got placed in the 9+ LPA range? I've heard the average is pulled up by a few very high offers. What's the median package for CSE 2025?" },
      { author: "Bernardo", body: "Fair point — the median is around 6.5–7 LPA for CSE. The average is pulled up by FAANG offers (40–80 LPA range) going to roughly 8–10% of the batch. Overall placement for CSE is about 85% within 6 months of graduation." },
      { author: "Bernardo",    body: "Is CGPA cutoff strictly enforced for placements? I've heard some companies at VIT require 8.0+. Is that standard?" },
      { author: "Bernardo", body: "Top-tier product companies typically require 8.5+ CGPA. Mid-tier use 7.0–7.5 as the bar. Maintain at least 8.0+ to maximize your options. VIT's system is on a 10-point scale." },
    ],
  },
  {
    author: "Ananya Patel",
    ...
    answers: [
      { author: "Bernardo", body: "VIT has a slight edge in research output in AI/ML. SRM's AI & ML program is newer but they've invested heavily in NVIDIA GPU clusters and industry tie-ups with IBM and Zoho. Both are solid choices." },
      { author: "Berd",  body: "I'd look at the faculty profiles. VIT has more internationally published AI researchers. SRM has been catching up fast since 2022 with new hires. Visit both campuses and talk to current students if possible." },
  ...
  },
  {
    ...
    answers: [
      { author: "Berd", body: "Sathyabama's Aerospace department has collaborations with ISRO and HAL which is a big deal for an undergrad. They have wind tunnel facilities and regular workshops with DRDO. For pure aerospace roles (HAL, NAL, ISRO), alumni placement is around 60–70% in core aerospace within 1 year." },
      { author: "Ananya Patel",   body: "The NAAC A++ accreditation matters a lot for government job eligibility and PSU recruitment. Their collaboration with ISRO Propulsion Complex gives real project exposure which is hard to get elsewhere in private universities." },
      { author: "Bernardo", body: "For aerospace, IITs and NITs will always be top-tier for core research roles. Sathyabama is an excellent choice if you didn't get those, especially for the ISRO pipeline. A great option for aerospace in the private university space." },
    ],
  },
  {
    author: "Bernardo",
    ...
    answers: [
      ...
      { author: "Bernardo", body: "For Integral Calculus — Arihant's book by Amit Agarwal is the go-to. Spend 2 weeks doing past 10 years of JEE Advanced calculus questions sorted by topic. Substitution, parts, partial fractions, and definite integral properties appear every year. Master those 4 topics first." },
      { author: "Ananya Patel",   body: "8 weeks is enough if you're strategic. Don't start new topics — only strengthen weak ones. Mock test every 3 days under real conditions. Analyze errors the day after: silly mistake, concept gap, or time management. Fix concept gaps only." },
    ],
  },
  {
    author: "Ananya Patel",
    ...
    answers: [
      { author: "Berd",  body: "Fill the maximum number of choices allowed — typically 100+. Order strictly by preference, not safety. The TNEA algorithm allocates you the highest-preference seat where your cutoff qualifies. So always put your dream seat first, even if it's a reach. Filling safe seats first is the biggest mistake." },
      { author: "Bernardo",  body: "With 194.25, you're in a strong range for good government colleges. CEG CSE might be a slight stretch, but put it first anyway. MIT IT, SAP ECE, and Guindy ECE should be in your top 10. Research all colleges — some hidden gems open up in later rounds." },
      { author: "Berd",  body: "Bookmark the TNEA portal's Statistics page which shows previous year opening/closing cutoffs for every college-branch combination. Use that as your guide when ordering choices." },
    ],
  },
];
