  ...
  return (
    <div className="min-h-screen bg-[#08080a] text-zinc-100 font-sans flex flex-col relative overflow-hidden">
      ...
      <main className="max-w-7xl mx-auto w-full px-6 py-12 flex-1 flex flex-col gap-6 relative z-10">
        ...
        >
          <Link href="/" className="inline-flex items-center gap-1.5 text-[9px] font-bold text-zinc-500 hover:text-white transition-colors uppercase tracking-widest group">
        ...
        {loading || authLoading ? (
          ...
          >
            <div className="w-14 h-14 rounded-full bg-[#0c0c10]/80 flex items-center justify-center text-zinc-500 border border-zinc-900/80 shadow-inner">
            ...
            <Link
              href="/"
              className="px-5 py-2.5 text-xs font-semibold bg-white hover:bg-zinc-250 text-black rounded-full transition-all duration-300 shadow-sm block animate-pulse hover:animate-none"
            >
              Start Exploring
            </Link>
          </motion.div>
      ...
      <footer className="border-t border-zinc-900 bg-[#060608] py-12 mt-auto relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-6 mt-8 pt-8 border-t border-zinc-950 flex items-center justify-between text-[10px] font-medium text-zinc-600">
